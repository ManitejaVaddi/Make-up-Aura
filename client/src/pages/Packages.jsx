  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      ...
      <div className="mt-14 grid gap-8 md:grid-cols-3">
        {packages.map((pkg) => (
          <article key={pkg.slug} className="rounded-[32px] bg-cream p-8 shadow-glass border border-rose-100">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <button
                ...
                className="rounded-full bg-rose-700 px-6 py-3 text-sm text-white transition hover:bg-rose-800"
              >
                Select package
              </button>
            </div>
